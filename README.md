...
[<p align="center"><img src="./files/logo.png" alt="Logo"/></p>](https://github.com/cheatsnake/backend-cheats/blob/master/README.md) ⭐ 5,085 | 🐛 5 | 📅 2025-02-02
...
> 🌐 Available translations: [`English`](https://github.com/cheatsnake/backend-cheats/blob/master/README.md) ⭐ 5,085 | 🐛 5 | 📅 2025-02-02 [`Русский`](https://github.com/cheatsnake/backend-cheats/blob/master/README_RUS.md) ⭐ 5,085 | 🐛 5 | 📅 2025-02-02

> 🤝 If you want to help the project, feel free to send your [issues](https://github.com/cheatsnake/backend-cheats/issues) ⭐ 5,085 | 🐛 5 | 📅 2025-02-02 or [pull requests](https://github.com/cheatsnake/backend-cheats/pulls) ⭐ 5,085 | 🐛 5 | 📅 2025-02-02.
...
1. 📄 [**Awesome CLI-apps** – GitHub](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,303 | 🐛 2 | 🌐 Shell | 📅 2026-09-01
2. 📄 [**Awesome Terminals** – GitHub](https://github.com/cdleon/awesome-terminals) ⭐ 2,952 | 🐛 22 | 📅 2026-07-20
...
* ### Bash scripts
  ...
  * [ShellCheck](https://github.com/koalaman/shellcheck) ⭐ 39,975 | 🐛 1,141 | 🌐 Haskell | 📅 2026-08-04 script analysis tool
  ...
  * Additional resources
    > Repositories such as [awesome bash](https://github.com/awesome-lists/awesome-bash) ⭐ 10,060 | 🐛 8 | 🌐 Shell | 📅 2026-05-21 and [awesome shell](https://github.com/alebcay/awesome-shell) ⭐ 37,551 | 🐛 184 | 📅 2025-08-28 have entire collections of useful resources and tools to help you develop even more skills with Bash and shell in general.
...
1. 📄 [**Awesome console services** – GitHub](https://github.com/chubin/awesome-console-services) ⭐ 6,519 | 🐛 24 | 📅 2026-02-01
...
* ### Main issues with Linux
  ...
  * File system issues
    ...
    > * In case of data loss or accidental deletion, use data recovery tools like [`extundelete`](https://extundelete.sourceforge.net/) or [`testdisk`](https://github.com/cgsecurity/testdisk) ⭐ 2,565 | 🐛 92 | 🌐 C | 📅 2026-08-19.
...
1. 📄 [**JavaScript Data Structures and Algorithms** – GitHub](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,592 | 🐛 403 | 🌐 JavaScript | 📅 2026-07-26
...
1. 📄 [**Code for the book Grokking Algorithms** – GitHub](https://github.com/egonSchiele/grokking_algorithms) ⭐ 13,657 | 🐛 6 | 🌐 JavaScript | 📅 2026-04-12
...
Find a good book or online tutorial in English at [this repository](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-langs.md) ⭐ 395,779 | 🐛 83 | 🌐 Python | 📅 2026-09-01. There is a large collection for different languages and frameworks.

Look for a special [awesome repository](https://github.com/sindresorhus/awesome#programming-languages) ⭐ 502,132 | 🐛 105 | 📅 2026-09-02 - a resource that contains a huge number of useful links to materials for your language (libraries, cheat sheets, blogs, and other various resources).
...
1. 📄 [**List of libraries for working with network in Go** – GitHub](https://github.com/avelino/awesome-go#networking) ⭐ 182,926 | 🐛 225 | 🌐 Go | 📅 2026-09-01
2. 📄 [**A curated list of awesome things related to Django** – GitHub](https://github.com/wsvincent/awesome-django) ⭐ 11,227 | 🐛 10 | 🌐 Python | 📅 2026-08-18
...
* ### Asynchronous programming
  ...
  * Asynchronous in particular languages
    > * In Python, asynchronous programming can be done using the [asyncio module](https://docs.python.org/3/library/asyncio.html), which provides an event loop and coroutine-based API for concurrency. There are also other third-party libraries like [Twisted](https://github.com/twisted/twisted) ⭐ 5,979 | 🐛 2,837 | 🌐 Python | 📅 2026-08-31 and [Tornado](https://github.com/tornadoweb/tornado) ⭐ 22,177 | 🐛 255 | 🌐 Python | 📅 2026-08-24 that provide asynchronous capabilities.
...
* ### Code quality
  ...
  * [JavaScript style guide by Airbnb](https://github.com/airbnb/javascript) ⭐ 148,142 | 🐛 164 | 🌐 JavaScript | 📅 2026-04-16
  * [Node.js best practices list](https://github.com/goldbergyoni/nodebestpractices) ⭐ 105,604 | 🐛 137 | 🌐 Dockerfile | 📅 2026-06-15
  * [Python style guide by Google](https://github.com/google/styleguide/blob/gh-pages/pyguide.md) ⭐ 39,556 | 🐛 170 | 🌐 HTML | 📅 2026-06-03
  * [Python best practices guidebook](https://github.com/realpython/python-guide) ⭐ 29,791 | 🐛 136 | 🌐 Batchfile | 📅 2026-07-27
  * [Go style guide by Uber](https://github.com/uber-go/guide) ⭐ 17,672 | 🐛 39 | 🌐 Makefile | 📅 2026-04-15
...
1. 📄 [**Google style guides** – GitHub](https://github.com/google/styleguide) ⭐ 39,556 | 🐛 170 | 🌐 HTML | 📅 2026-06-03
...
1. 📄 [**Awesome MongoDB** – GitHub](https://github.com/ramnes/awesome-mongodb) ⭐ 2,675 | 🐛 6 | 📅 2026-08-26
...
1. 📄 [**Awesome list of GraphQL** – GitHub](https://github.com/chentsulin/awesome-graphql) ⭐ 15,111 | 🐛 5 | 📅 2026-08-26
...
1. 📄 [**Collection of .gitignore templates** – GitHub](https://github.com/github/gitignore) ⭐ 175,543 | 🐛 84 | 📅 2026-09-01
...
1. 📄 [**Awesome Docker** – GitHub](https://github.com/veggiemonk/awesome-docker) ⭐ 36,762 | 🐛 27 | 📅 2026-08-27
...
1. 📄 [**Awesome ChatGPT Prompts** – GitHub](https://github.com/f/awesome-chatgpt-prompts) ⭐ 168,497 | 🐛 71 | 🌐 HTML | 📅 2026-09-02
...
1. 📄 [**Awesome AWS (list of libraries, open source repos, guides, blogs) – GitHub**](https://github.com/donnemartin/awesome-aws) ⭐ 14,133 | 🐛 102 | 🌐 Python | 📅 2024-03-12
...
2. 📄 [**Awesome Kubernetes Resources – GitHub**](https://github.com/tomhuang12/awesome-k8s-resources) ⭐ 4,217 | 🐛 74 | 📅 2025-05-20
...
1. 📄 [**Awesome GitHub Actions – GitHub**](https://github.com/sdras/awesome-actions) ⭐ 28,184 | 🐛 282 | 📅 2024-09-01
...
* ### Monitoring and logs
  ...
  * [Graylog](https://github.com/Graylog2/graylog2-server) ⭐ 8,122 | 🐛 2,067 | 🌐 Java | 📅 2026-09-02
  ...
  * Libraries for your lang
    > The easiest way to log an application is to use the tools of the standard language library or third-party packages. For example, in Python you can use [logging module](https://docs.python.org/3/library/logging.html) or [Loguru](https://github.com/Delgan/loguru) ⭐ 24,090 | 🐛 253 | 🌐 Python | 📅 2026-08-30. In Node.js – [Winston](https://github.com/winstonjs/winston) ⭐ 24,513 | 🐛 531 | 🌐 JavaScript | 📅 2026-07-20, [Pino](https://github.com/pinojs/pino) ⭐ 18,178 | 🐛 172 | 🌐 JavaScript | 📅 2026-09-01. And in Go – [log package](https://pkg.go.dev/log), [Logrus](https://github.com/sirupsen/logrus) ⭐ 25,745 | 🐛 46 | 🌐 Go | 📅 2026-08-25.
...
* ### Markdown
  ...
  * [Awesome README](https://github.com/matiassingers/awesome-readme) ⭐ 21,404 | 🐛 1 | 📅 2026-08-20
...
6. 📄 [**Awesome Microservices: collection of principles and technologies** – GitHub](https://github.com/mfornos/awesome-microservices) ⭐ 14,504 | 🐛 8 | 📅 2026-08-20
...
* [System Design 101: Explain complex systems using visuals and simple terms](https://github.com/ByteByteGoHq/system-design-101) ⭐ 87,862 | 🐛 67 | 📅 2025-04-04
* [Computer Science courses with video lectures](https://github.com/Developer-Y/cs-video-courses) ⭐ 83,382 | 🐛 4 | 📅 2026-08-30
* [System Design Course](https://github.com/karanpratapsingh/system-design) ⭐ 45,907 | 🐛 4 | 📅 2026-07-08
* [Awesome CTO – resources for Chief Technology Officers and VP R\&D](https://github.com/kuchin/awesome-cto) ⭐ 35,404 | 🐛 4 | 📅 2026-03-02
* [Awesome Sysadmin: A curated list of open source sysadmin resources](https://github.com/awesome-foss/awesome-sysadmin) ⭐ 35,044 | 🐛 0 | 📅 2026-08-29
* [How To Secure A Linux Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 31,104 | 🐛 36 | 📅 2026-07-13
* [Domain-Driven Design, software architecture, design patterns, best practices](https://github.com/Sairyss/domain-driven-hexagon) ⭐ 14,902 | 🐛 5 | 🌐 TypeScript | 📅 2024-06-11
* [Mindmaps for cyber security](https://github.com/Ignitetechnologies/Mindmap) ⭐ 9,245 | 🐛 15 | 📅 2026-07-21
* [A curated and opinionated list of resources for Backend developers](https://github.com/zhashkevych/awesome-backend) ⭐ 3,457 | 🐛 6 | 📅 2026-04-17
