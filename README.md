...
[<p align="center"><img src="./files/logo.png" alt="Logo"/></p>](https://github.com/cheatsnake/backend-cheats/blob/master/README.md) ⭐ 5,125 | 🐛 5 | 📅 2025-02-02
...
> 🌐 Available translations: [`English`](https://github.com/cheatsnake/backend-cheats/blob/master/README.md) ⭐ 5,125 | 🐛 5 | 📅 2025-02-02 [`Русский`](https://github.com/cheatsnake/backend-cheats/blob/master/README_RUS.md) ⭐ 5,125 | 🐛 5 | 📅 2025-02-02

> 🤝 If you want to help the project, feel free to send your [issues](https://github.com/cheatsnake/backend-cheats/issues) ⭐ 5,125 | 🐛 5 | 📅 2025-02-02 or [pull requests](https://github.com/cheatsnake/backend-cheats/pulls) ⭐ 5,125 | 🐛 5 | 📅 2025-02-02.
...
4. 📄 [**Awesome Hosting** – GitHub](https://github.com/dalisoft/awesome-hosting) ⭐ 929 | 🐛 0 | 📅 2026-09-13
...
1. 📄 [**Awesome CLI-apps** – GitHub](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,387 | 🐛 1 | 🌐 Shell | 📅 2026-09-13
2. 📄 [**Awesome Terminals** – GitHub](https://github.com/cdleon/awesome-terminals) ⭐ 2,972 | 🐛 24 | 📅 2026-07-20
...
* ### Bash scripts
  ...
  * [ShellCheck](https://github.com/koalaman/shellcheck) ⭐ 40,035 | 🐛 1,140 | 🌐 Haskell | 📅 2026-08-04 script analysis tool
  ...
  * Additional resources
    > Repositories such as [awesome bash](https://github.com/awesome-lists/awesome-bash) ⭐ 10,073 | 🐛 7 | 🌐 Shell | 📅 2026-05-21 and [awesome shell](https://github.com/alebcay/awesome-shell) ⭐ 37,614 | 🐛 186 | 📅 2025-08-28 have entire collections of useful resources and tools to help you develop even more skills with Bash and shell in general.
...
1. 📄 [**Awesome SSH** – GitHub](https://github.com/moul/awesome-ssh) ⭐ 2,838 | 🐛 48 | 📅 2023-08-10
...
* ### Main issues with Linux
  ...
  * File system issues
    ...
    > * In case of data loss or accidental deletion, use data recovery tools like [`extundelete`](https://extundelete.sourceforge.net/) or [`testdisk`](https://github.com/cgsecurity/testdisk) ⭐ 2,583 | 🐛 92 | 🌐 C | 📅 2026-08-19.
...
1. 📄 [**JavaScript Data Structures and Algorithms** – GitHub](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,708 | 🐛 406 | 🌐 JavaScript | 📅 2026-07-26
...
1. 📄 [**Code for the book Grokking Algorithms** – GitHub](https://github.com/egonSchiele/grokking_algorithms) ⭐ 13,679 | 🐛 6 | 🌐 JavaScript | 📅 2026-04-12
...
Find a good book or online tutorial in English at [this repository](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-langs.md) ⭐ 396,727 | 🐛 82 | 🌐 Python | 📅 2026-09-13. There is a large collection for different languages and frameworks.

Look for a special [awesome repository](https://github.com/sindresorhus/awesome#programming-languages) ⭐ 505,876 | 🐛 106 | 📅 2026-09-02 - a resource that contains a huge number of useful links to materials for your language (libraries, cheat sheets, blogs, and other various resources).
...
1. 📄 [**List of libraries for working with network in Go** – GitHub](https://github.com/avelino/awesome-go#networking) ⭐ 184,079 | 🐛 231 | 🌐 Go | 📅 2026-09-14
2. 📄 [**A curated list of awesome things related to Django** – GitHub](https://github.com/wsvincent/awesome-django) ⭐ 11,241 | 🐛 4 | 🌐 Python | 📅 2026-09-06
...
* ### Asynchronous programming
  ...
  * Asynchronous in particular languages
    > * In Python, asynchronous programming can be done using the [asyncio module](https://docs.python.org/3/library/asyncio.html), which provides an event loop and coroutine-based API for concurrency. There are also other third-party libraries like [Twisted](https://github.com/twisted/twisted) ⭐ 5,979 | 🐛 2,825 | 🌐 Python | 📅 2026-09-13 and [Tornado](https://github.com/tornadoweb/tornado) ⭐ 22,178 | 🐛 255 | 🌐 Python | 📅 2026-09-13 that provide asynchronous capabilities.
...
* ### Code quality
  ...
  * [JavaScript style guide by Airbnb](https://github.com/airbnb/javascript) ⭐ 148,226 | 🐛 164 | 🌐 JavaScript | 📅 2026-04-16
  * [Node.js best practices list](https://github.com/goldbergyoni/nodebestpractices) ⭐ 105,614 | 🐛 138 | 🌐 Dockerfile | 📅 2026-06-15
  * [Python style guide by Google](https://github.com/google/styleguide/blob/gh-pages/pyguide.md) ⭐ 39,602 | 🐛 170 | 🌐 HTML | 📅 2026-09-13
  * [Python best practices guidebook](https://github.com/realpython/python-guide) ⭐ 29,806 | 🐛 136 | 🌐 Batchfile | 📅 2026-07-27
  * [Go style guide by Uber](https://github.com/uber-go/guide) ⭐ 17,702 | 🐛 39 | 🌐 Makefile | 📅 2026-04-15
...
1. 📄 [**Google style guides** – GitHub](https://github.com/google/styleguide) ⭐ 39,602 | 🐛 170 | 🌐 HTML | 📅 2026-09-13
...
1. 📄 [**Awesome REST** – GitHub](https://github.com/marmelab/awesome-rest) ⭐ 3,914 | 🐛 17 | 📅 2026-05-13
...
1. 📄 [**Collection of .gitignore templates** – GitHub](https://github.com/github/gitignore) ⭐ 175,762 | 🐛 73 | 📅 2026-09-11
...
1. 📄 [**Awesome Docker** – GitHub](https://github.com/veggiemonk/awesome-docker) ⭐ 36,819 | 🐛 32 | 📅 2026-09-12
...
1. 📄 [**Awesome ChatGPT Prompts** – GitHub](https://github.com/f/awesome-chatgpt-prompts) ⭐ 170,282 | 🐛 78 | 🌐 HTML | 📅 2026-09-09
...
* ### Unit Tests
  ...
  * What do I need to start writing unit tests?
    ...
    > * For Go – [testify](https://github.com/stretchr/testify) ⭐ 26,203 | 🐛 377 | 🌐 Go | 📅 2026-09-02.
    > * [And so on...](https://github.com/atinfo/awesome-test-automation#awesome-test-automation) ⭐ 7,157 | 🐛 138 | 📅 2025-11-28
...
1. 📄 [**Awesome Testing** – GitHub](https://github.com/TheJambo/awesome-testing) ⭐ 2,371 | 🐛 13 | 📅 2026-09-13
...
1. 📄 [**Awesome GitHub Actions – GitHub**](https://github.com/sdras/awesome-actions) ⭐ 28,219 | 🐛 305 | 📅 2024-09-01
...
* ### Monitoring and logs
  ...
  * [Graylog](https://github.com/Graylog2/graylog2-server) ⭐ 8,129 | 🐛 2,079 | 🌐 Java | 📅 2026-09-14
  ...
  * Libraries for your lang
    > The easiest way to log an application is to use the tools of the standard language library or third-party packages. For example, in Python you can use [logging module](https://docs.python.org/3/library/logging.html) or [Loguru](https://github.com/Delgan/loguru) ⭐ 24,103 | 🐛 255 | 🌐 Python | 📅 2026-08-30. In Node.js – [Winston](https://github.com/winstonjs/winston) ⭐ 24,520 | 🐛 532 | 🌐 JavaScript | 📅 2026-07-20, [Pino](https://github.com/pinojs/pino) ⭐ 18,193 | 🐛 172 | 🌐 JavaScript | 📅 2026-09-05. And in Go – [log package](https://pkg.go.dev/log), [Logrus](https://github.com/sirupsen/logrus) ⭐ 25,748 | 🐛 46 | 🌐 Go | 📅 2026-08-25.
...
* ### Benchmarks
  ...
  * What specific tools are there for this?
    ...
    > For Node.js: [console.time](https://nodejs.org/api/console.html#consoletimelabel), [Artillery](https://github.com/artilleryio/artillery) ⭐ 9,075 | 🐛 486 | 🌐 TypeScript | 📅 2026-08-26. <br>
...
* ### Markdown
  ...
  * [Markdown cheatsheet](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet) ⭐ 60,245 | 🐛 319 | 🌐 JavaScript | 📅 2025-08-22
    > A cheatsheet on all the syntactic possibilities of the language.
  * [Awesome README](https://github.com/matiassingers/awesome-readme) ⭐ 21,437 | 🐛 1 | 📅 2026-09-10
    > A collection of beautiful README.md files (this is the main file of any repository on GitHub that uses Markdown).
  * [Awesome Markdown](https://github.com/BubuAnabelas/awesome-markdown) ⭐ 958 | 🐛 72 | 📅 2024-08-21
...
* ### Documentation inside code
  ...
  * What does it take to get started?
    ...
    > * [JSDoc](https://github.com/jsdoc/jsdoc) ⭐ 15,458 | 🐛 459 | 🌐 JavaScript | 📅 2026-09-12 for JavaScript.
...
6. 📄 [**Awesome Microservices: collection of principles and technologies** – GitHub](https://github.com/mfornos/awesome-microservices) ⭐ 14,509 | 🐛 10 | 📅 2026-08-20
...
* [System Design 101: Explain complex systems using visuals and simple terms](https://github.com/ByteByteGoHq/system-design-101) ⭐ 89,165 | 🐛 68 | 📅 2025-04-04
* [Computer Science courses with video lectures](https://github.com/Developer-Y/cs-video-courses) ⭐ 83,496 | 🐛 4 | 📅 2026-09-11
* [System Design Course](https://github.com/karanpratapsingh/system-design) ⭐ 46,059 | 🐛 3 | 📅 2026-07-08
* [Awesome CTO – resources for Chief Technology Officers and VP R\&D](https://github.com/kuchin/awesome-cto) ⭐ 35,447 | 🐛 6 | 📅 2026-03-02
* [Awesome Sysadmin: A curated list of open source sysadmin resources](https://github.com/awesome-foss/awesome-sysadmin) ⭐ 35,139 | 🐛 0 | 📅 2026-09-02
* [How To Secure A Linux Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 31,410 | 🐛 32 | 📅 2026-09-07
* [Domain-Driven Design, software architecture, design patterns, best practices](https://github.com/Sairyss/domain-driven-hexagon) ⭐ 14,927 | 🐛 5 | 🌐 TypeScript | 📅 2024-06-11
