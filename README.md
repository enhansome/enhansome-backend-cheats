...
[<p align="center"><img src="./files/logo.png" alt="Logo"/></p>](https://github.com/cheatsnake/backend-cheats/blob/master/README.md) ⭐ 5,162 | 🐛 5 | 📅 2025-02-02
...
> 🌐 Available translations: [`English`](https://github.com/cheatsnake/backend-cheats/blob/master/README.md) ⭐ 5,162 | 🐛 5 | 📅 2025-02-02 [`Русский`](https://github.com/cheatsnake/backend-cheats/blob/master/README_RUS.md) ⭐ 5,162 | 🐛 5 | 📅 2025-02-02

> 🤝 If you want to help the project, feel free to send your [issues](https://github.com/cheatsnake/backend-cheats/issues) ⭐ 5,162 | 🐛 5 | 📅 2025-02-02 or [pull requests](https://github.com/cheatsnake/backend-cheats/pulls) ⭐ 5,162 | 🐛 5 | 📅 2025-02-02.
...
4. 📄 [**Awesome Hosting** – GitHub](https://github.com/dalisoft/awesome-hosting) ⭐ 936 | 🐛 0 | 📅 2026-09-21
...
1. 📄 [**Awesome CLI-apps** – GitHub](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,451 | 🐛 0 | 🌐 Shell | 📅 2026-09-21
2. 📄 [**Awesome Terminals** – GitHub](https://github.com/cdleon/awesome-terminals) ⭐ 3,000 | 🐛 26 | 📅 2026-09-22
...
* ### Bash scripts
  ...
  * [ShellCheck](https://github.com/koalaman/shellcheck) ⭐ 40,074 | 🐛 1,134 | 🌐 Haskell | 📅 2026-09-21 script analysis tool
  ...
  * Additional resources
    > Repositories such as [awesome bash](https://github.com/awesome-lists/awesome-bash) ⭐ 10,089 | 🐛 7 | 🌐 Shell | 📅 2026-05-21 and [awesome shell](https://github.com/alebcay/awesome-shell) ⭐ 37,661 | 🐛 187 | 📅 2025-08-28 have entire collections of useful resources and tools to help you develop even more skills with Bash and shell in general.
...
1. 📄 [**Awesome console services** – GitHub](https://github.com/chubin/awesome-console-services) ⭐ 6,534 | 🐛 26 | 📅 2026-02-01
...
Find a good book or online tutorial in English at [this repository](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-langs.md) ⭐ 397,479 | 🐛 82 | 🌐 Python | 📅 2026-09-22. There is a large collection for different languages and frameworks.

Look for a special [awesome repository](https://github.com/sindresorhus/awesome#programming-languages) ⭐ 509,138 | 🐛 106 | 📅 2026-09-02 - a resource that contains a huge number of useful links to materials for your language (libraries, cheat sheets, blogs, and other various resources).
...
1. 📄 [**List of libraries for working with network in Go** – GitHub](https://github.com/avelino/awesome-go#networking) ⭐ 185,215 | 🐛 230 | 🌐 Go | 📅 2026-09-23
...
* ### Asynchronous programming
  ...
  * Asynchronous in particular languages
    > * In Python, asynchronous programming can be done using the [asyncio module](https://docs.python.org/3/library/asyncio.html), which provides an event loop and coroutine-based API for concurrency. There are also other third-party libraries like [Twisted](https://github.com/twisted/twisted) ⭐ 5,986 | 🐛 2,830 | 🌐 Python | 📅 2026-09-17 and [Tornado](https://github.com/tornadoweb/tornado) ⭐ 22,179 | 🐛 259 | 🌐 Python | 📅 2026-09-22 that provide asynchronous capabilities.
...
* ### Code quality
  ...
  * [JavaScript style guide by Airbnb](https://github.com/airbnb/javascript) ⭐ 148,262 | 🐛 165 | 🌐 JavaScript | 📅 2026-04-16
  * [Node.js best practices list](https://github.com/goldbergyoni/nodebestpractices) ⭐ 105,634 | 🐛 138 | 🌐 Dockerfile | 📅 2026-06-15
  * [Python style guide by Google](https://github.com/google/styleguide/blob/gh-pages/pyguide.md) ⭐ 39,627 | 🐛 170 | 🌐 HTML | 📅 2026-09-21
  * [Python best practices guidebook](https://github.com/realpython/python-guide) ⭐ 29,815 | 🐛 136 | 🌐 Batchfile | 📅 2026-07-27
  * [Go style guide by Uber](https://github.com/uber-go/guide) ⭐ 17,721 | 🐛 39 | 🌐 Makefile | 📅 2026-04-15
...
1. 📄 [**Google style guides** – GitHub](https://github.com/google/styleguide) ⭐ 39,627 | 🐛 170 | 🌐 HTML | 📅 2026-09-21
...
1. 📄 [**Awesome REST** – GitHub](https://github.com/marmelab/awesome-rest) ⭐ 3,916 | 🐛 13 | 📅 2026-05-13
...
1. 📄 [**Awesome list of GraphQL** – GitHub](https://github.com/chentsulin/awesome-graphql) ⭐ 15,122 | 🐛 0 | 🌐 Ruby | 📅 2026-09-18
...
1. 📄 [**Collection of .gitignore templates** – GitHub](https://github.com/github/gitignore) ⭐ 175,875 | 🐛 77 | 📅 2026-09-11
...
1. 📄 [**Awesome Docker** – GitHub](https://github.com/veggiemonk/awesome-docker) ⭐ 36,875 | 🐛 37 | 📅 2026-09-12
...
1. 📄 [**Awesome NGINX** – GitHub](https://github.com/agile6v/awesome-nginx) ⭐ 1,292 | 🐛 5 | 🌐 C | 📅 2026-09-22
...
1. 📄 [**Awesome ChatGPT Prompts** – GitHub](https://github.com/f/awesome-chatgpt-prompts) ⭐ 171,063 | 🐛 78 | 🌐 HTML | 📅 2026-09-09
...
* ### Unit Tests
  ...
  * What do I need to start writing unit tests?
    ...
    > * For Go – [testify](https://github.com/stretchr/testify) ⭐ 26,211 | 🐛 380 | 🌐 Go | 📅 2026-09-02.
...
1. 📄 [**Awesome Testing** – GitHub](https://github.com/TheJambo/awesome-testing) ⭐ 2,380 | 🐛 22 | 📅 2026-09-13
...
1. 📄 [**Awesome GitHub Actions – GitHub**](https://github.com/sdras/awesome-actions) ⭐ 28,248 | 🐛 317 | 📅 2024-09-01
...
* ### Monitoring and logs
  ...
  * [Graylog](https://github.com/Graylog2/graylog2-server) ⭐ 8,142 | 🐛 2,096 | 🌐 Java | 📅 2026-09-23
  ...
  * Libraries for your lang
    > The easiest way to log an application is to use the tools of the standard language library or third-party packages. For example, in Python you can use [logging module](https://docs.python.org/3/library/logging.html) or [Loguru](https://github.com/Delgan/loguru) ⭐ 24,124 | 🐛 257 | 🌐 Python | 📅 2026-08-30. In Node.js – [Winston](https://github.com/winstonjs/winston) ⭐ 24,521 | 🐛 533 | 🌐 JavaScript | 📅 2026-07-20, [Pino](https://github.com/pinojs/pino) ⭐ 18,217 | 🐛 171 | 🌐 JavaScript | 📅 2026-09-05. And in Go – [log package](https://pkg.go.dev/log), [Logrus](https://github.com/sirupsen/logrus) ⭐ 25,750 | 🐛 47 | 🌐 Go | 📅 2026-08-25.
...
* ### Benchmarks
  ...
  * What specific tools are there for this?
    ...
    > For Node.js: [console.time](https://nodejs.org/api/console.html#consoletimelabel), [Artillery](https://github.com/artilleryio/artillery) ⭐ 9,081 | 🐛 487 | 🌐 TypeScript | 📅 2026-09-22. <br>
...
* ### Markdown
  ...
  * [Awesome README](https://github.com/matiassingers/awesome-readme) ⭐ 21,474 | 🐛 1 | 📅 2026-09-17
...
* ### Documentation inside code
  ...
  * What does it take to get started?
    ...
    > * [JSDoc](https://github.com/jsdoc/jsdoc) ⭐ 15,464 | 🐛 462 | 🌐 JavaScript | 📅 2026-09-23 for JavaScript.
...
6. 📄 [**Awesome Microservices: collection of principles and technologies** – GitHub](https://github.com/mfornos/awesome-microservices) ⭐ 14,519 | 🐛 12 | 📅 2026-08-20
...
* [System Design 101: Explain complex systems using visuals and simple terms](https://github.com/ByteByteGoHq/system-design-101) ⭐ 89,815 | 🐛 68 | 📅 2025-04-04
* [Computer Science courses with video lectures](https://github.com/Developer-Y/cs-video-courses) ⭐ 83,553 | 🐛 5 | 📅 2026-09-21
* [System Design Course](https://github.com/karanpratapsingh/system-design) ⭐ 46,295 | 🐛 4 | 📅 2026-07-08
* [Awesome CTO – resources for Chief Technology Officers and VP R\&D](https://github.com/kuchin/awesome-cto) ⭐ 35,498 | 🐛 8 | 📅 2026-03-02
* [Awesome Sysadmin: A curated list of open source sysadmin resources](https://github.com/awesome-foss/awesome-sysadmin) ⭐ 35,236 | 🐛 0 | 📅 2026-09-17
* [How To Secure A Linux Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 31,460 | 🐛 32 | 📅 2026-09-07
* [Domain-Driven Design, software architecture, design patterns, best practices](https://github.com/Sairyss/domain-driven-hexagon) ⭐ 14,944 | 🐛 5 | 🌐 TypeScript | 📅 2024-06-11
* [Mindmaps for cyber security](https://github.com/Ignitetechnologies/Mindmap) ⭐ 9,266 | 🐛 15 | 📅 2026-07-21
