...
[<p align="center"><img src="./files/logo.png" alt="Logo"/></p>](https://github.com/cheatsnake/backend-cheats/blob/master/README.md) ⭐ 5,117 | 🐛 5 | 📅 2025-02-02
...
> 🌐 Available translations: [`English`](https://github.com/cheatsnake/backend-cheats/blob/master/README.md) ⭐ 5,117 | 🐛 5 | 📅 2025-02-02 [`Русский`](https://github.com/cheatsnake/backend-cheats/blob/master/README_RUS.md) ⭐ 5,117 | 🐛 5 | 📅 2025-02-02

> 🤝 If you want to help the project, feel free to send your [issues](https://github.com/cheatsnake/backend-cheats/issues) ⭐ 5,117 | 🐛 5 | 📅 2025-02-02 or [pull requests](https://github.com/cheatsnake/backend-cheats/pulls) ⭐ 5,117 | 🐛 5 | 📅 2025-02-02.
...
1. 📄 [**Putting the "You" in CPU: explainer how your computer runs programs, from start to finish**](https://github.com/hackclub/putting-the-you-in-cpu) ⭐ 5,555 | 🐛 40 | 🌐 MDX | 📅 2026-07-03
...
1. 📄 [**Awesome CLI-apps** – GitHub](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,363 | 🐛 1 | 🌐 Shell | 📅 2026-09-05
2. 📄 [**Awesome Terminals** – GitHub](https://github.com/cdleon/awesome-terminals) ⭐ 2,966 | 🐛 24 | 📅 2026-07-20
...
* ### Bash scripts
  ...
  * [ShellCheck](https://github.com/koalaman/shellcheck) ⭐ 40,022 | 🐛 1,139 | 🌐 Haskell | 📅 2026-08-04 script analysis tool
  ...
  * Additional resources
    > Repositories such as [awesome bash](https://github.com/awesome-lists/awesome-bash) ⭐ 10,067 | 🐛 7 | 🌐 Shell | 📅 2026-05-21 and [awesome shell](https://github.com/alebcay/awesome-shell) ⭐ 37,587 | 🐛 184 | 📅 2025-08-28 have entire collections of useful resources and tools to help you develop even more skills with Bash and shell in general.
...
1. 📄 [**Awesome console services** – GitHub](https://github.com/chubin/awesome-console-services) ⭐ 6,527 | 🐛 24 | 📅 2026-02-01
...
* ### Main issues with Linux
  ...
  * File system issues
    ...
    > * In case of data loss or accidental deletion, use data recovery tools like [`extundelete`](https://extundelete.sourceforge.net/) or [`testdisk`](https://github.com/cgsecurity/testdisk) ⭐ 2,579 | 🐛 92 | 🌐 C | 📅 2026-08-19.
...
1. 📄 [**JavaScript Data Structures and Algorithms** – GitHub](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,673 | 🐛 404 | 🌐 JavaScript | 📅 2026-07-26
...
Find a good book or online tutorial in English at [this repository](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-langs.md) ⭐ 396,487 | 🐛 82 | 🌐 Python | 📅 2026-09-10. There is a large collection for different languages and frameworks.

Look for a special [awesome repository](https://github.com/sindresorhus/awesome#programming-languages) ⭐ 504,946 | 🐛 106 | 📅 2026-09-02 - a resource that contains a huge number of useful links to materials for your language (libraries, cheat sheets, blogs, and other various resources).
...
1. 📄 [**List of libraries for working with network in Go** – GitHub](https://github.com/avelino/awesome-go#networking) ⭐ 183,775 | 🐛 233 | 🌐 Go | 📅 2026-09-10
2. 📄 [**A curated list of awesome things related to Django** – GitHub](https://github.com/wsvincent/awesome-django) ⭐ 11,239 | 🐛 4 | 🌐 Python | 📅 2026-09-06
...
* ### Asynchronous programming
  ...
  * Asynchronous in particular languages
    > * In Python, asynchronous programming can be done using the [asyncio module](https://docs.python.org/3/library/asyncio.html), which provides an event loop and coroutine-based API for concurrency. There are also other third-party libraries like [Twisted](https://github.com/twisted/twisted) ⭐ 5,978 | 🐛 2,834 | 🌐 Python | 📅 2026-09-10 and [Tornado](https://github.com/tornadoweb/tornado) ⭐ 22,177 | 🐛 255 | 🌐 Python | 📅 2026-08-24 that provide asynchronous capabilities.
...
* ### Code quality
  ...
  * [JavaScript style guide by Airbnb](https://github.com/airbnb/javascript) ⭐ 148,200 | 🐛 163 | 🌐 JavaScript | 📅 2026-04-16
  * [Node.js best practices list](https://github.com/goldbergyoni/nodebestpractices) ⭐ 105,609 | 🐛 138 | 🌐 Dockerfile | 📅 2026-06-15
  * [Python style guide by Google](https://github.com/google/styleguide/blob/gh-pages/pyguide.md) ⭐ 39,591 | 🐛 170 | 🌐 HTML | 📅 2026-09-11
  * [Python best practices guidebook](https://github.com/realpython/python-guide) ⭐ 29,801 | 🐛 136 | 🌐 Batchfile | 📅 2026-07-27
...
1. 📄 [**Google style guides** – GitHub](https://github.com/google/styleguide) ⭐ 39,591 | 🐛 170 | 🌐 HTML | 📅 2026-09-11
...
1. 📄 [**Awesome list of GraphQL** – GitHub](https://github.com/chentsulin/awesome-graphql) ⭐ 15,113 | 🐛 4 | 📅 2026-09-10
...
1. 📄 [**Collection of .gitignore templates** – GitHub](https://github.com/github/gitignore) ⭐ 175,707 | 🐛 74 | 📅 2026-09-08
...
1. 📄 [**Awesome Docker** – GitHub](https://github.com/veggiemonk/awesome-docker) ⭐ 36,808 | 🐛 35 | 📅 2026-09-09
...
1. 📄 [**Awesome NGINX** – GitHub](https://github.com/agile6v/awesome-nginx) ⭐ 1,290 | 🐛 6 | 🌐 C | 📅 2026-09-06
...
1. 📄 [**Awesome ChatGPT Prompts** – GitHub](https://github.com/f/awesome-chatgpt-prompts) ⭐ 169,927 | 🐛 77 | 🌐 HTML | 📅 2026-09-09
...
* ### Unit Tests
  ...
  * What do I need to start writing unit tests?
    ...
    > * For Go – [testify](https://github.com/stretchr/testify) ⭐ 26,202 | 🐛 377 | 🌐 Go | 📅 2026-09-02.
    > * [And so on...](https://github.com/atinfo/awesome-test-automation#awesome-test-automation) ⭐ 7,156 | 🐛 137 | 📅 2025-11-28
...
1. 📄 [**Awesome Testing** – GitHub](https://github.com/TheJambo/awesome-testing) ⭐ 2,372 | 🐛 17 | 📅 2026-09-04
...
1. 📄 [**Awesome AWS (list of libraries, open source repos, guides, blogs) – GitHub**](https://github.com/donnemartin/awesome-aws) ⭐ 14,143 | 🐛 103 | 🌐 Python | 📅 2024-03-12
...
1. 📄 [**Kubernetes Learning Roadmap** – GitHub](https://github.com/techiescamp/kubernetes-learning-path) ⭐ 7,636 | 🐛 2 | 📅 2026-05-28
2. 📄 [**Awesome Kubernetes Resources – GitHub**](https://github.com/tomhuang12/awesome-k8s-resources) ⭐ 4,223 | 🐛 77 | 📅 2025-05-20
...
1. 📄 [**Awesome GitHub Actions – GitHub**](https://github.com/sdras/awesome-actions) ⭐ 28,209 | 🐛 297 | 📅 2024-09-01
...
* ### Monitoring and logs
  ...
  * [Graylog](https://github.com/Graylog2/graylog2-server) ⭐ 8,127 | 🐛 2,075 | 🌐 Java | 📅 2026-09-11
  ...
  * Libraries for your lang
    > The easiest way to log an application is to use the tools of the standard language library or third-party packages. For example, in Python you can use [logging module](https://docs.python.org/3/library/logging.html) or [Loguru](https://github.com/Delgan/loguru) ⭐ 24,100 | 🐛 255 | 🌐 Python | 📅 2026-08-30. In Node.js – [Winston](https://github.com/winstonjs/winston) ⭐ 24,517 | 🐛 532 | 🌐 JavaScript | 📅 2026-07-20, [Pino](https://github.com/pinojs/pino) ⭐ 18,189 | 🐛 172 | 🌐 JavaScript | 📅 2026-09-05. And in Go – [log package](https://pkg.go.dev/log), [Logrus](https://github.com/sirupsen/logrus) ⭐ 25,746 | 🐛 46 | 🌐 Go | 📅 2026-08-25.
...
* ### Benchmarks
  ...
  * What specific tools are there for this?
    ...
    > For Node.js: [console.time](https://nodejs.org/api/console.html#consoletimelabel), [Artillery](https://github.com/artilleryio/artillery) ⭐ 9,074 | 🐛 486 | 🌐 TypeScript | 📅 2026-08-26. <br>
...
* ### Documentation inside code
  ...
  * What does it take to get started?
    ...
    > * [JSDoc](https://github.com/jsdoc/jsdoc) ⭐ 15,457 | 🐛 459 | 🌐 JavaScript | 📅 2026-09-11 for JavaScript.
...
6. 📄 [**Awesome Microservices: collection of principles and technologies** – GitHub](https://github.com/mfornos/awesome-microservices) ⭐ 14,504 | 🐛 9 | 📅 2026-08-20
...
* [System Design 101: Explain complex systems using visuals and simple terms](https://github.com/ByteByteGoHq/system-design-101) ⭐ 89,071 | 🐛 68 | 📅 2025-04-04
* [Computer Science courses with video lectures](https://github.com/Developer-Y/cs-video-courses) ⭐ 83,468 | 🐛 5 | 📅 2026-09-06
* [System Design Course](https://github.com/karanpratapsingh/system-design) ⭐ 46,020 | 🐛 3 | 📅 2026-07-08
* [Awesome CTO – resources for Chief Technology Officers and VP R\&D](https://github.com/kuchin/awesome-cto) ⭐ 35,438 | 🐛 6 | 📅 2026-03-02
* [Awesome Sysadmin: A curated list of open source sysadmin resources](https://github.com/awesome-foss/awesome-sysadmin) ⭐ 35,117 | 🐛 0 | 📅 2026-09-02
* [How To Secure A Linux Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 31,395 | 🐛 32 | 📅 2026-09-07
* [Domain-Driven Design, software architecture, design patterns, best practices](https://github.com/Sairyss/domain-driven-hexagon) ⭐ 14,922 | 🐛 5 | 🌐 TypeScript | 📅 2024-06-11
* [Mindmaps for cyber security](https://github.com/Ignitetechnologies/Mindmap) ⭐ 9,254 | 🐛 15 | 📅 2026-07-21
* [A curated and opinionated list of resources for Backend developers](https://github.com/zhashkevych/awesome-backend) ⭐ 3,463 | 🐛 6 | 📅 2026-04-17
* [Awesome Network Automation](https://github.com/networktocode/awesome-network-automation) ⭐ 2,846 | 🐛 16 | 📅 2026-08-20
* [Best practices, tools, and guidelines for backend development](https://github.com/Sairyss/backend-best-practices) ⭐ 2,376 | 🐛 1 | 📅 2024-08-29
