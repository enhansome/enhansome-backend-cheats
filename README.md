...
[<p align="center"><img src="./files/logo.png" alt="Logo"/></p>](https://github.com/cheatsnake/backend-cheats/blob/master/README.md) ⭐ 5,120 | 🐛 5 | 📅 2025-02-02
...
> 🌐 Available translations: [`English`](https://github.com/cheatsnake/backend-cheats/blob/master/README.md) ⭐ 5,120 | 🐛 5 | 📅 2025-02-02 [`Русский`](https://github.com/cheatsnake/backend-cheats/blob/master/README_RUS.md) ⭐ 5,120 | 🐛 5 | 📅 2025-02-02

> 🤝 If you want to help the project, feel free to send your [issues](https://github.com/cheatsnake/backend-cheats/issues) ⭐ 5,120 | 🐛 5 | 📅 2025-02-02 or [pull requests](https://github.com/cheatsnake/backend-cheats/pulls) ⭐ 5,120 | 🐛 5 | 📅 2025-02-02.
...
4. 📄 [**Awesome Hosting** – GitHub](https://github.com/dalisoft/awesome-hosting) ⭐ 927 | 🐛 1 | 📅 2026-09-07
...
1. 📄 [**Awesome CLI-apps** – GitHub](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,373 | 🐛 3 | 🌐 Shell | 📅 2026-09-05
...
* ### Bash scripts
  ...
  * [ShellCheck](https://github.com/koalaman/shellcheck) ⭐ 40,030 | 🐛 1,139 | 🌐 Haskell | 📅 2026-08-04 script analysis tool
  ...
  * Additional resources
    > Repositories such as [awesome bash](https://github.com/awesome-lists/awesome-bash) ⭐ 10,070 | 🐛 7 | 🌐 Shell | 📅 2026-05-21 and [awesome shell](https://github.com/alebcay/awesome-shell) ⭐ 37,597 | 🐛 184 | 📅 2025-08-28 have entire collections of useful resources and tools to help you develop even more skills with Bash and shell in general.
...
1. 📄 [**JavaScript Data Structures and Algorithms** – GitHub](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,683 | 🐛 404 | 🌐 JavaScript | 📅 2026-07-26
...
1. 📄 [**Code for the book Grokking Algorithms** – GitHub](https://github.com/egonSchiele/grokking_algorithms) ⭐ 13,676 | 🐛 6 | 🌐 JavaScript | 📅 2026-04-12
...
Find a good book or online tutorial in English at [this repository](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-langs.md) ⭐ 396,571 | 🐛 86 | 🌐 Python | 📅 2026-09-10. There is a large collection for different languages and frameworks.

Look for a special [awesome repository](https://github.com/sindresorhus/awesome#programming-languages) ⭐ 505,237 | 🐛 106 | 📅 2026-09-02 - a resource that contains a huge number of useful links to materials for your language (libraries, cheat sheets, blogs, and other various resources).
...
1. 📄 [**List of libraries for working with network in Go** – GitHub](https://github.com/avelino/awesome-go#networking) ⭐ 183,872 | 🐛 233 | 🌐 Go | 📅 2026-09-10
...
* ### Asynchronous programming
  ...
  * Asynchronous in particular languages
    > * In Python, asynchronous programming can be done using the [asyncio module](https://docs.python.org/3/library/asyncio.html), which provides an event loop and coroutine-based API for concurrency. There are also other third-party libraries like [Twisted](https://github.com/twisted/twisted) ⭐ 5,979 | 🐛 2,834 | 🌐 Python | 📅 2026-09-12 and [Tornado](https://github.com/tornadoweb/tornado) ⭐ 22,177 | 🐛 255 | 🌐 Python | 📅 2026-08-24 that provide asynchronous capabilities.
...
* ### Code quality
  ...
  * [JavaScript style guide by Airbnb](https://github.com/airbnb/javascript) ⭐ 148,206 | 🐛 163 | 🌐 JavaScript | 📅 2026-04-16
  * [Node.js best practices list](https://github.com/goldbergyoni/nodebestpractices) ⭐ 105,610 | 🐛 139 | 🌐 Dockerfile | 📅 2026-06-15
  * [Python style guide by Google](https://github.com/google/styleguide/blob/gh-pages/pyguide.md) ⭐ 39,596 | 🐛 170 | 🌐 HTML | 📅 2026-09-11
...
1. 📄 [**Google style guides** – GitHub](https://github.com/google/styleguide) ⭐ 39,596 | 🐛 170 | 🌐 HTML | 📅 2026-09-11
...
1. 📄 [**Collection of .gitignore templates** – GitHub](https://github.com/github/gitignore) ⭐ 175,727 | 🐛 73 | 📅 2026-09-11
...
1. 📄 [**Awesome ChatGPT Prompts** – GitHub](https://github.com/f/awesome-chatgpt-prompts) ⭐ 170,030 | 🐛 77 | 🌐 HTML | 📅 2026-09-09
...
1. 📄 [**Awesome Testing** – GitHub](https://github.com/TheJambo/awesome-testing) ⭐ 2,372 | 🐛 18 | 📅 2026-09-04
...
1. 📄 [**Awesome GitHub Actions – GitHub**](https://github.com/sdras/awesome-actions) ⭐ 28,214 | 🐛 298 | 📅 2024-09-01
...
* ### Monitoring and logs
  ...
  * [Graylog](https://github.com/Graylog2/graylog2-server) ⭐ 8,127 | 🐛 2,080 | 🌐 Java | 📅 2026-09-12
  ...
  * Libraries for your lang
    > The easiest way to log an application is to use the tools of the standard language library or third-party packages. For example, in Python you can use [logging module](https://docs.python.org/3/library/logging.html) or [Loguru](https://github.com/Delgan/loguru) ⭐ 24,102 | 🐛 255 | 🌐 Python | 📅 2026-08-30. In Node.js – [Winston](https://github.com/winstonjs/winston) ⭐ 24,519 | 🐛 532 | 🌐 JavaScript | 📅 2026-07-20, [Pino](https://github.com/pinojs/pino) ⭐ 18,191 | 🐛 172 | 🌐 JavaScript | 📅 2026-09-05. And in Go – [log package](https://pkg.go.dev/log), [Logrus](https://github.com/sirupsen/logrus) ⭐ 25,746 | 🐛 46 | 🌐 Go | 📅 2026-08-25.
...
* ### Markdown
  ...
  * [Awesome README](https://github.com/matiassingers/awesome-readme) ⭐ 21,432 | 🐛 1 | 📅 2026-09-10
...
* ### Documentation inside code
  ...
  * What does it take to get started?
    ...
    > * [JSDoc](https://github.com/jsdoc/jsdoc) ⭐ 15,458 | 🐛 459 | 🌐 JavaScript | 📅 2026-09-11 for JavaScript.
...
* [System Design 101: Explain complex systems using visuals and simple terms](https://github.com/ByteByteGoHq/system-design-101) ⭐ 89,094 | 🐛 68 | 📅 2025-04-04
* [Computer Science courses with video lectures](https://github.com/Developer-Y/cs-video-courses) ⭐ 83,480 | 🐛 4 | 📅 2026-09-11
* [System Design Course](https://github.com/karanpratapsingh/system-design) ⭐ 46,030 | 🐛 3 | 📅 2026-07-08
* [Awesome CTO – resources for Chief Technology Officers and VP R\&D](https://github.com/kuchin/awesome-cto) ⭐ 35,440 | 🐛 6 | 📅 2026-03-02
* [Awesome Sysadmin: A curated list of open source sysadmin resources](https://github.com/awesome-foss/awesome-sysadmin) ⭐ 35,124 | 🐛 0 | 📅 2026-09-02
* [How To Secure A Linux Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 31,398 | 🐛 32 | 📅 2026-09-07
