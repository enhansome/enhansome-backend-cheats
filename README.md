...
[<p align="center"><img src="./files/logo.png" alt="Logo"/></p>](https://github.com/cheatsnake/backend-cheats/blob/master/README.md) ⭐ 5,061 | 🐛 5 | 📅 2025-02-02
...
> 🌐 Available translations: [`English`](https://github.com/cheatsnake/backend-cheats/blob/master/README.md) ⭐ 5,061 | 🐛 5 | 📅 2025-02-02 [`Русский`](https://github.com/cheatsnake/backend-cheats/blob/master/README_RUS.md) ⭐ 5,061 | 🐛 5 | 📅 2025-02-02

> 🤝 If you want to help the project, feel free to send your [issues](https://github.com/cheatsnake/backend-cheats/issues) ⭐ 5,061 | 🐛 5 | 📅 2025-02-02 or [pull requests](https://github.com/cheatsnake/backend-cheats/pulls) ⭐ 5,061 | 🐛 5 | 📅 2025-02-02.
...
4. 📄 [**Awesome Hosting** – GitHub](https://github.com/dalisoft/awesome-hosting) ⭐ 923 | 🐛 2 | 📅 2026-08-20
...
1. 📄 [**Putting the "You" in CPU: explainer how your computer runs programs, from start to finish**](https://github.com/hackclub/putting-the-you-in-cpu) ⭐ 5,546 | 🐛 39 | 🌐 MDX | 📅 2026-07-03
...
1. 📄 [**Awesome Operating System Stuff** – GitHub](https://github.com/jubalh/awesome-os) ⭐ 2,264 | 🐛 1 | 📅 2026-07-27
...
5. 📺 [**Operating System Basics** – YouTube](https://youtu.be/9GDX-IyZ_C8)
6. 📺 [**Operating System in deep details (playlist)** – YouTube](https://youtube.com/playlist?list=PLBlnK6fEyqRiVhbXDGLXDk_OQAeuVcp2O)
...
1. 📄 [**Awesome CLI-apps** – GitHub](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,238 | 🐛 1 | 🌐 Shell | 📅 2026-08-22
2. 📄 [**Awesome Terminals** – GitHub](https://github.com/cdleon/awesome-terminals) ⭐ 2,943 | 🐛 20 | 📅 2026-07-20
...
6. 📺 [**The 50 Most Popular Linux & Terminal Commands** – YouTube](https://youtu.be/ZtqBQ68cfJc)
7. 📺 [**Nano Editor Fundamentals** – YouTube](https://youtu.be/gyKiDczLIZ4)
8. 📺 [**Vim Tutorial for Beginners** – YouTube](https://youtu.be/RZ4p-saaQkc)
...
* ### Bash scripts
  ...
  * [ShellCheck](https://github.com/koalaman/shellcheck) ⭐ 39,919 | 🐛 1,139 | 🌐 Haskell | 📅 2026-08-04 script analysis tool
    > It will point out possible mistakes and teach you best practices for writing really good scripts.
  * [Basics of Bash Scripts](https://github.com/cheatsnake/bash-scripts-by-example) ⭐ 65 | 🐛 0 | 📅 2025-04-07
  ...
  * Additional resources
    > Repositories such as [awesome bash](https://github.com/awesome-lists/awesome-bash) ⭐ 10,044 | 🐛 8 | 🌐 Shell | 📅 2026-05-21 and [awesome shell](https://github.com/alebcay/awesome-shell) ⭐ 37,501 | 🐛 184 | 📅 2025-08-28 have entire collections of useful resources and tools to help you develop even more skills with Bash and shell in general.

<details>
    <summary>🔗 <b>References</b></summary>

1. 📄 [**HackerRank challenges for Bash with solutions**](https://github.com/Thomas-George-T/HackerRank-The-Linux-Shell-Challenges-Solutions) ⭐ 112 | 🐛 1 | 🌐 Shell | 📅 2024-04-16
2. 📄 [**Shell Scripting for Beginners** – freeCodeCamp](https://www.freecodecamp.org/news/shell-scripting-crash-course-how-to-write-bash-scripts-in-linux/)
3. 📺 [**Bash Scripting Full Course 3 Hours** – YouTube](https://youtu.be/e7BufAVwDiM)
...
1. 📄 [**Awesome SSH** – GitHub](https://github.com/moul/awesome-ssh) ⭐ 2,835 | 🐛 46 | 📅 2023-08-10
...
5. 📄 [**SSH config file for OpenSSH client**](https://www.ssh.com/academy/ssh/config)
...
1. 📄 [**Awesome console services** – GitHub](https://github.com/chubin/awesome-console-services) ⭐ 6,510 | 🐛 23 | 📅 2026-02-01
...
5. 📺 [**tcpdumping Node.js server** – YouTube](https://youtu.be/g_tmQ5G-T2w)
6. 📄 [**Beginner’s guide to Netcat for hackers**](https://medium.com/@HackTheBridge/beginners-guide-to-netcat-for-hackers-55abe449991d)
7. 📄 [**Iptables Tutorial**](https://linuxhint.com/iptables-tutorial/)
8. 📄 [**An intro to cURL: The basics of the transfer tool**](https://blog.logrocket.com/an-intro-to-curl-the-basics-of-the-transfer-tool/)
9. 📺 [**Basic cURL Tutorial** – YouTube](https://youtu.be/7XUibDYw4mc)
10. 📺 [**Using cURL better - tutorial by cURL creator Daniel Stenberg** – YouTube](https://youtu.be/I6id1Y0YuNk)
...
* ### System logs
  ...
  * Log rotation with [logrotate](https://github.com/logrotate/logrotate) ⭐ 1,545 | 🐛 64 | 🌐 C | 📅 2026-08-01
...
* ### Main issues with Linux
  ...
  * File system issues
    ...
    > * In case of data loss or accidental deletion, use data recovery tools like [`extundelete`](https://extundelete.sourceforge.net/) or [`testdisk`](https://github.com/cgsecurity/testdisk) ⭐ 2,545 | 🐛 92 | 🌐 C | 📅 2026-08-19.
...
2. 📄 [**Number System in Maths** – GeeksGorGeeks](https://www.geeksforgeeks.org/number-system-in-maths/)
...
1. 📄 [**JavaScript Data Structures and Algorithms** – GitHub](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,548 | 🐛 405 | 🌐 JavaScript | 📅 2026-07-26
2. 📄 [**Go Data Structures** – GitHub](https://github.com/emirpasic/gods) ⭐ 17,457 | 🐛 73 | 🌐 Go | 📅 2025-03-12
...
6. 📄 [**Free courses to learn data structures and algorithms in depth** – freeCodeCamp](https://www.freecodecamp.org/news/these-are-the-best-free-courses-to-learn-data-structures-and-algorithms-in-depth-4d52f0d6b35a/)
7. 📄 [**Data Structures: collection of topics** – GeeksForGeeks](https://www.geeksforgeeks.org/data-structures/)
...
1. 📄 [**Code for the book Grokking Algorithms** – GitHub](https://github.com/egonSchiele/grokking_algorithms) ⭐ 13,636 | 🐛 6 | 🌐 JavaScript | 📅 2026-04-12
...
Find a good book or online tutorial in English at [this repository](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-langs.md) ⭐ 395,163 | 🐛 87 | 🌐 Python | 📅 2026-08-18. There is a large collection for different languages and frameworks.

Look for a special [awesome repository](https://github.com/sindresorhus/awesome#programming-languages) ⭐ 499,662 | 🐛 106 | 📅 2026-08-21 - a resource that contains a huge number of useful links to materials for your language (libraries, cheat sheets, blogs, and other various resources).
...
* ### Language Basics
  ...
  * [Regular expressions](https://github.com/cheatsnake/regex-by-example) ⭐ 14 | 🐛 0 | 📅 2023-01-24
...
1. 📄 [**List of libraries for working with network in Go** – GitHub](https://github.com/avelino/awesome-go#networking) ⭐ 182,162 | 🐛 215 | 🌐 Go | 📅 2026-08-25
2. 📄 [**A curated list of awesome things related to Django** – GitHub](https://github.com/wsvincent/awesome-django) ⭐ 11,223 | 🐛 10 | 🌐 Python | 📅 2026-08-18
...
7. 📺 [**Python Web Scraping for Beginners** – YouTube](https://youtu.be/mBoX_JCKZTE)
8. 📺 [**Build servers in pure Node.js** – YouTube](https://youtu.be/_1xa8Bsho6A)
9. 📄 [**Learn Express – web framework for Node.js**](https://developer.mozilla.org/en-US/docs/Learn/Server-side/Express_Nodejs)
10. 📺 [**Express.js 2022 Course** – YouTube](https://youtube.com/playlist?list=PL_cUvD4qzbkwp6pxx27pqgohrsP8v1Wj2)
11. 📄 [**How to build servers in Go**](https://eli.thegreenplace.net/2021/rest-servers-in-go-part-1-standard-library/)
12. 📺 [**Golang server development course** – YouTube](https://youtube.com/playlist?list=PLzUGFf4GhXBL4GHXVcMMvzgtO8-WEJIoY)
13. 📄 [**Web services in Go** – GitBook](https://astaxie.gitbooks.io/build-web-application-with-golang/content/en/08.0.html)
...
* ### Asynchronous programming
  ...
  * Asynchronous in particular languages
    > * In Python, asynchronous programming can be done using the [asyncio module](https://docs.python.org/3/library/asyncio.html), which provides an event loop and coroutine-based API for concurrency. There are also other third-party libraries like [Twisted](https://github.com/twisted/twisted) ⭐ 5,976 | 🐛 2,833 | 🌐 Python | 📅 2026-08-23 and [Tornado](https://github.com/tornadoweb/tornado) ⭐ 22,180 | 🐛 252 | 🌐 Python | 📅 2026-08-24 that provide asynchronous capabilities.
...
5. 📺 [**How to use Multithreading with "worker threads" in Node.js?** – YouTube](https://youtu.be/MuwJJrfIfsU)
6. 📺 [**Concurrency in Go** – YouTube](https://youtube.com/playlist?list=PLsc-VaxfZl4do3Etp_xQ0aQBoC-x5BIgJ)
7. 📺 [**Kotlin coroutines** – YouTube](https://youtube.com/playlist?list=PLQkwcJG4YTCQcFEPuYGuv54nYai_lwil_)
...
* ### Code quality
  ...
  * [JavaScript style guide by Airbnb](https://github.com/airbnb/javascript) ⭐ 148,131 | 🐛 163 | 🌐 JavaScript | 📅 2026-04-16
  * [Node.js best practices list](https://github.com/goldbergyoni/nodebestpractices) ⭐ 105,602 | 🐛 138 | 🌐 Dockerfile | 📅 2026-06-15
  * [Python style guide by Google](https://github.com/google/styleguide/blob/gh-pages/pyguide.md) ⭐ 39,530 | 🐛 170 | 🌐 HTML | 📅 2026-06-03
  * [Python best practices guidebook](https://github.com/realpython/python-guide) ⭐ 29,778 | 🐛 136 | 🌐 Batchfile | 📅 2026-07-27
  * [Go style guide by Uber](https://github.com/uber-go/guide) ⭐ 17,661 | 🐛 39 | 🌐 Makefile | 📅 2026-04-15
  * [and other…](https://github.com/kciter/awesome-style-guide) ⭐ 1,109 | 🐛 0 | 🌐 Ruby | 📅 2023-01-19
...
1. 📄 [**Google style guides** – GitHub](https://github.com/google/styleguide) ⭐ 39,530 | 🐛 170 | 🌐 HTML | 📅 2026-06-03
...
5. 📺 [**Why you shouldn't write comments in your code** – YouTube](https://youtu.be/Bf7vDBBOBUA)
6. 📺 [**How principled coders outperform the competition** – YouTube](https://youtu.be/q1qKv5TBaOA)
7. 📺 [**Uncle Bob SOLID principles** – YouTube](https://youtu.be/zHiWqnTWsn4)
8. 📄 [**SOLID Principles explained in Python** – medium](https://towardsdev.com/solid-principles-explained-635ad3608b20)
9. 📄 [**SOLID Principles in JavaScript** – freeCodeCamp](https://www.freecodecamp.org/news/solid-principles-for-programming-and-software-design/)
...
* ### Relational database
  ...
  * [SQL basics](https://github.com/cheatsnake/sql-by-example/blob/master/README.md) ⭐ 17 | 🐛 0 | 📅 2023-05-30
  ...
  * Working with a programming language
    > To do this, you need to install a database driver (adapter) for your language. (For example [psycopg2](https://github.com/psycopg/psycopg2) ⭐ 3,650 | 🐛 27 | 🌐 C | 📅 2026-05-02 for Python, [node-postgres](https://github.com/brianc/node-postgres) ⭐ 13,197 | 🐛 518 | 🌐 JavaScript | 📅 2026-08-18 for Node.js, [pgx](https://github.com/jackc/pgx) ⭐ 14,179 | 🐛 251 | 🌐 Go | 📅 2026-08-24 for Go)
  * [ORM (Object-Relational Mapping)](https://en.wikipedia.org/wiki/Object%E2%80%93relational_mapping) libraries
    > Writing SQL queries in code is difficult. It's easy to make mistakes and typos in them, because they are just strings that are not validated in any way. To solve this problem, there are so-called ORM libraries, which allow you to execute SQL queries as if you were simply calling methods on an object. Unfortunately, even with them all is not so smooth, because "under the hood" queries that are generated by these libraries are not the most optimal in terms of performance (so be prepared to work with ORM, as well as with pure SQL). <br> Popular ORMs: [SQLAlchemy](https://github.com/sqlalchemy/sqlalchemy) ⭐ 12,105 | 🐛 206 | 🌐 Python | 📅 2026-08-24 for Python, [Prisma](https://github.com/prisma/prisma) ⭐ 47,569 | 🐛 2,555 | 🌐 TypeScript | 📅 2026-08-24 for Node.js, [GORM](https://github.com/go-gorm/gorm) ⭐ 39,925 | 🐛 518 | 🌐 Go | 📅 2026-06-25 for Go.
  * [Optimization and performance](https://postgrespro.ru/docs/postgresql/14/performance-tips)

<details>
    <summary>🔗 <b>References</b></summary>

1. 📄 [**Awesome SQL** – GitHub](https://github.com/danhuss/awesome-sql) ⭐ 451 | 🐛 22 | 📅 2026-04-25
2. 📺 [**SQL Crash Course - Beginner to Intermediate** – YouTube](https://youtu.be/nWeW3sCmD2k)
3. 📺 [**SQL Tutorial for Beginners (and Technical Interview Questions Solved)** – YouTube](https://youtu.be/-fW2X7fh7Yg)
4. 📺 [**SQL Tutorial - Full Database Course for Beginners** – YouTube](https://youtu.be/HXV3zeQKqGY)
5. 📺 [**MySQL - The Basics. Learn SQL in 23 Easy Steps** – YouTube](https://youtu.be/Cz3WcZLRaWc)
6. 📄 [**MySQL command-line client commands**](https://www.mysqltutorial.org/mysql-cheat-sheet.aspx)
7. 📺 [**Learn PostgreSQL Tutorial - Full Course for Beginners** – YouTube](https://youtu.be/qw--VYLpxG4)
8. 📄 [**Postgres Cheat Sheet**](https://postgrescheatsheet.com)
9. 📺 [**Database Indexing Explained (with PostgreSQL)** – YouTube](https://youtu.be/-qNSXK7s7_w)
10. 📄 [**SQL Indexing and Tuning e-Book**](https://use-the-index-luke.com/)
11. 📺 [**What is a Database transaction?** – YouTube](https://youtu.be/P80Js_qClUE)
12. 📺 [**SQL Server Performance Essentials – Full Course** – YouTube](https://youtu.be/HvxmF0FUwrM)
13. 📺 [**ORM: The Good, the Great, and the Ugly** – YouTube](https://youtu.be/3EvhK7-DlZA)
14. 📺 [**I Would Never Use an ORM, by Matteo Collina** – YouTube](https://youtu.be/qfRQ5zhYuJE)
...
1. 📄 [**Awesome MongoDB** – GitHub](https://github.com/ramnes/awesome-mongodb) ⭐ 2,673 | 🐛 5 | 📅 2026-08-05
...
5. 📄 [**MongoDB Cheat Sheet**](https://www.mongodb.com/developer/products/mongodb/cheat-sheet/)
6. 📺 [**MongoDB Tutorial For Beginners (playlist)** – YouTube](https://youtube.com/playlist?list=PLp50dWW_m40UWFSV6PTgYzciZJIxgHy7Q)
...
* ### Redis
  ...
  [Redis](https://redis.io/) is a fast data storage working with *key-value* structures. It can be used as a database, cache, message broker or queue.
...
1. 📄 [**Awesome Redis** – GitHub](https://github.com/JamzyWang/awesome-redis) ⭐ 745 | 🐛 7 | 📅 2024-04-16
2. 📺 [**Redis in 100 Seconds** – YouTube](https://youtu.be/G1rOthIU-uo)
3. 📺 [**Redis In-Memory Database Crash Course** – YouTube](https://youtu.be/V7FPk4J10KI)
4. 📺 [**Redis Course - In-Memory Database Tutorial** – YouTube](https://youtu.be/XCsS_NVAa1g)
5. 📺 [**Redis Crash Course - Transactions** – YouTube](https://youtu.be/5seIrOGYHPo)
6. 📺 [**Python and Redis Tutorial - Caching API Responses** – YouTube](https://youtu.be/_8lJ5lp8P0U)
7. 📺 [**Top 5 Redis Use Cases** – YouTube](https://youtu.be/a4yX7RUgTxI)
8. 📄 [**How To Run Transactions in Redis** – Digital Ocean](https://www.digitalocean.com/community/cheatsheets/how-to-run-transactions-in-redis)
9. 📄 [**Redis cheatsheet** – QuickRef](https://quickref.me/redis)
...
* ### REST API
  ...
  * [Versioning](https://github.com/NationalBankBelgium/REST-API-Design-Guide/wiki/REST-API-Versioning) ⭐ 827 | 🐛 8 | 📅 2018-11-29
...
1. 📄 [**Awesome REST** – GitHub](https://github.com/marmelab/awesome-rest) ⭐ 3,907 | 🐛 15 | 📅 2026-05-13
2. 📄 [**REST API design full guide** – GitHub](https://github.com/NationalBankBelgium/REST-API-Design-Guide/wiki) ⭐ 827 | 🐛 8 | 📅 2018-11-29
3. 📄 [**What Is RESTful API?** – AWS](https://aws.amazon.com/what-is/restful-api/?nc1=h_ls)
4. 📺 [**What is REST API?** – YouTube](https://youtu.be/lsMQRaeKNDk)
5. 📺 [**APIs for Beginners 2023 - How to use an API (Full Course)** – YouTube](https://youtu.be/WXsD0ZgxjRw)
6. 📺 [**Build Web APIs with Python – Django REST Framework Course** – YouTube](https://youtu.be/tujhGdn1EMI)
7. 📺 [**Build an API from Scratch with Node.js Express** – YouTube](https://youtu.be/-MTSQjw5DrM)
8. 📺 [**Build REST API on Vanilla Node.js** – YouTube](https://youtu.be/_1xa8Bsho6A)
9. 📺 [**Build a REST API with Go** – YouTube](https://youtu.be/d_L64KT3SFM)
10. 📺 [**Spring Kotlin - Building a REST API Tutorial** – YouTube](https://youtube.com/playlist?list=PLNnNHr-wCfobAxSkuxMqFGdpA8E5cLR6w)
...
1. 📄 [**Awesome list of GraphQL** – GitHub](https://github.com/chentsulin/awesome-graphql) ⭐ 15,106 | 🐛 6 | 📅 2026-08-14
...
5. 📺 [**Python with GraphQL tutorial** – YouTube](https://youtu.be/ZUrNFhG3LK4)
6. 📺 [**Modern GraphQL with Node.js Crash Course** – YouTube](https://youtu.be/qux4-yWeZvo)
7. 📺 [**GraphQL in Go - GQLGen Tutorial** – YouTube](https://youtu.be/O6jYy421tGw)
...
* ### WebSockets
  ...
  * Connection closing codes
    > `1000`, `1001`, `1006`, `1009`, `1011`, [etc.](https://github.com/Luka967/websocket-close-codes) ⭐ 248 | 🐛 0 | 📅 2024-07-08

<details>
    <summary>🔗 <b>References</b></summary>

1. 📄 [**Awesome WebSockets** – GitHub](https://github.com/facundofarias/awesome-websockets) ⭐ 1,859 | 🐛 3 | 📅 2026-08-17
2. 📺 [**A Beginner's Guide to WebSockets** – YouTube](https://youtu.be/8ARodQ4Wlf4)
3. 📺 [**WebSockets Crash Course - Handshake, Use-cases, Pros & Cons and more** – YouTube](https://youtu.be/2Nt-ZrNP22A)
4. 📄 [**Introducing WebSockets - Bringing Sockets to the Web**](https://web.dev/websockets-basics)
5. 📺 [**WebSockets with Python tutorial** – YouTube](https://youtu.be/lv0oEnQY1pM)
6. 📺 [**WebSockets with Node.js tutorial** – YouTube](https://youtu.be/1BfCnjr_Vjg)
7. 📺 [**WebSockets with Go tutorial** – YouTube](https://youtu.be/JuUAEYLkGbM)
...
1. 📄 [**Awesome gRPC** – GitHub](https://github.com/grpc-ecosystem/awesome-grpc) ⭐ 8,354 | 🐛 26 | 📅 2025-10-28
...
5. 📺 [**This is why gRPC was invented** – YouTube](https://youtu.be/u4LWEXDP7_M)
6. 📺 [**gRPC with Python - microservice complete tutorial** – YouTube](https://youtu.be/E0CaocyNYKg)
7. 📺 [**Implementing a gRPC client and server in TypeScript with Node.js** – YouTube](https://youtu.be/H0c4Wjl4kRQ)
8. 📺 [**Build a gRPC server with Go - Step-by-step tutorial** – YouTube](https://youtu.be/gbrPMv_GuQY)
...
* ### Git version control system
  ...
  * [Git style guide](https://github.com/agis/git-style-guide#table-of-contents) ⭐ 5,115 | 🐛 0 | 📅 2022-09-26
  ...
  * [Working with branches](https://github.com/cheatsnake/quick-git#working-with-branches) ⭐ 2 | 🐛 0 | 📅 2023-08-07
    > Branch is a sequence of commits.
  * [Remote repositories](https://github.com/cheatsnake/quick-git#remote-repositories) ⭐ 2 | 🐛 0 | 📅 2023-08-07
    > A repository is a place where the source code and change history (commits) of your project is stored.
  * [Commit deletions and rollbacks](https://github.com/cheatsnake/quick-git#commit-deletions-and-rollbacks) ⭐ 2 | 🐛 0 | 📅 2023-08-07
...
1. 📄 [**Collection of .gitignore templates** – GitHub](https://github.com/github/gitignore) ⭐ 175,443 | 🐛 82 | 📅 2026-07-23
...
5. 📺 [**13 Advanced (but useful) Git Techniques and Shortcuts** – YouTube](https://youtu.be/RGOj5yH7evk)
6. 📄 [**Understanding Git through images** – dev.to](https://dev.to/nopenoshishi/understanding-git-through-images-4an1)
7. 📄 [**Git Cheat Sheet – 50 Git Commands You Should Know** – freeCodeCamp](https://www.freecodecamp.org/news/git-cheat-sheet/)
8. 📄 [**Git Commit Patterns** – dev.to](https://dev.to/hornet_daemon/git-commit-patterns-5dm7)
...
1. 📄 [**Awesome Docker** – GitHub](https://github.com/veggiemonk/awesome-docker) ⭐ 36,706 | 🐛 16 | 📅 2026-08-19
...
6. 📺 [**Docker Compose Tutorial** – YouTube](https://youtu.be/HG6yIjZapSA)
7. 📺 [**Docker networking – everything you need to know** – YouTube](https://youtu.be/bKFMS5C4CG0)
...
1. 📄 [**Awesome NGINX** – GitHub](https://github.com/agile6v/awesome-nginx) ⭐ 1,286 | 🐛 5 | 🌐 C | 📅 2026-08-23
...
5. 📺 [**Nginx Server Complete Course** – YouTube](https://youtu.be/tMtFZdaaIhk)
6. 📄 [**6 Best Courses to learn Nginx in depth** – medium](https://medium.com/javarevisited/best-courses-to-learn-nginx-in-36ed9ccca804)
7. 📄 [**NGINX: Advanced Load Balancer, Web Server, & Reverse Proxy** – dev.to](https://dev.to/lovepreetsingh/nginx-advanced-load-balancer-web-server-reverse-proxy-4i23)
...
1. 📄 [**Awesome ChatGPT Prompts** – GitHub](https://github.com/f/awesome-chatgpt-prompts) ⭐ 167,866 | 🐛 69 | 🌐 HTML | 📅 2026-08-24
...
* ### Unit Tests
  ...
  * What do I need to start writing unit tests?
    ...
    > * For Go – [testify](https://github.com/stretchr/testify) ⭐ 26,179 | 🐛 363 | 🌐 Go | 📅 2026-08-24.
    > * [And so on...](https://github.com/atinfo/awesome-test-automation#awesome-test-automation) ⭐ 7,146 | 🐛 129 | 📅 2025-11-28
...
1. 📄 [**Awesome Testing** – GitHub](https://github.com/TheJambo/awesome-testing) ⭐ 2,356 | 🐛 7 | 📅 2026-08-22
...
5. 📺 [**End to End - Test Driven Development (TDD) to create a REST API in Go** – YouTube](https://youtu.be/tG9dPO6fe4E)
6. 📺 [**How to test HTTP handlers in Go** – YouTube](https://youtu.be/Ztk9d78HgC0)
...
1. 📄 [**Awesome AWS (list of libraries, open source repos, guides, blogs) – GitHub**](https://github.com/donnemartin/awesome-aws) ⭐ 14,128 | 🐛 101 | 🌐 Python | 📅 2024-03-12
2. 📄 [**Awesome Google Cloud Platform – GitHub**](https://github.com/GoogleCloudPlatform/awesome-google-cloud) ⚠️ Archived
3. 📄 [**Awesome Digital Ocean – GitHub**](https://github.com/jonleibowitz/awesome-digitalocean) ⭐ 380 | 🐛 3 | 📅 2021-04-30
...
7. 📺 [**Google Cloud Associate Cloud Engineer Course** – YouTube](https://youtu.be/jpno8FSqpc8)
8. 📺 [**Microsoft Azure Fundamentals Certification Course** – YouTube](https://youtu.be/NKEFWyqJ5XA)
9. 📺 [**Full DigitalOcean Crash Course** – YouTube](https://youtu.be/9ZUHSW1tTiU)
...
1. 📄 [**Kubernetes Learning Roadmap** – GitHub](https://github.com/techiescamp/kubernetes-learning-path) ⭐ 7,627 | 🐛 2 | 📅 2026-05-28
2. 📄 [**Awesome Kubernetes Resources – GitHub**](https://github.com/tomhuang12/awesome-k8s-resources) ⭐ 4,210 | 🐛 72 | 📅 2025-05-20
3. 📄 [**Awesome Swarm** – GitHub](https://github.com/BretFisher/awesome-swarm) ⭐ 746 | 🐛 6 | 📅 2026-08-19
...
6. 📄 [**Top 8 Docker Best Practices for using Docker in Production** – dev.to](https://dev.to/techworld_with_nana/top-8-docker-best-practices-for-using-docker-in-production-1m39)
7. 📺 [**Best practices around creating a production web app with Docker and Docker Compose** – YouTube](https://youtu.be/vYpPGCaKs3I)
8. 📺 [**Docker Swarm Tutorial** – YouTube](https://youtu.be/Tm0Q5zr3FL4)
9. 📄 [**Kubernetes vs. Docker Swarm – What is the Difference?**](https://www.freecodecamp.org/news/kubernetes-vs-docker-swarm-what-is-the-difference/)
10. 📄 [**Kubernetes Roadmap**](https://roadmap.sh/kubernetes)
11. 📺 [**Docker Containers and Kubernetes Fundamentals – Full Hands-On Course** – YouTube](https://youtu.be/kTp5xUtcalw)
12. 📺 [**Kubernetes Course - Full Beginners Tutorial (Containerize Your Apps!)** – YouTube](https://youtu.be/d6WC5n9G_sM)
...
1. 📄 [**Awesome GitHub Actions – GitHub**](https://github.com/sdras/awesome-actions) ⭐ 28,163 | 🐛 266 | 📅 2024-09-01
...
* ### Monitoring and logs
  ...
  * [Graylog](https://github.com/Graylog2/graylog2-server) ⭐ 8,113 | 🐛 2,049 | 🌐 Java | 📅 2026-08-25
  ...
  * Libraries for your lang
    > The easiest way to log an application is to use the tools of the standard language library or third-party packages. For example, in Python you can use [logging module](https://docs.python.org/3/library/logging.html) or [Loguru](https://github.com/Delgan/loguru) ⭐ 24,080 | 🐛 253 | 🌐 Python | 📅 2026-08-23. In Node.js – [Winston](https://github.com/winstonjs/winston) ⭐ 24,507 | 🐛 529 | 🌐 JavaScript | 📅 2026-07-20, [Pino](https://github.com/pinojs/pino) ⭐ 18,153 | 🐛 167 | 🌐 JavaScript | 📅 2026-08-13. And in Go – [log package](https://pkg.go.dev/log), [Logrus](https://github.com/sirupsen/logrus) ⭐ 25,751 | 🐛 44 | 🌐 Go | 📅 2026-08-19.
...
1. 📄 [**Awesome Elasticsearch – GitHub**](https://github.com/dzharii/awesome-elasticsearch) ⚠️ Archived
2. 📄 [**Awesome Prometheus – GitHub**](https://github.com/roaldnefs/awesome-prometheus) ⭐ 86 | 🐛 3 | 📅 2024-07-30
3. 📺 [**Grafana Loki a log aggregation system for everything** – YouTube](https://youtu.be/h_GGd7HfKQ8)
4. 📺 [**Graylog guide to getting started log management** – YouTube](https://youtu.be/DwYwrADwCmg)
5. 📺 [**Overview of the Elastic Stack (formerly ELK stack)** – YouTube](https://youtu.be/Hqn5p67uev4)
6. 📺 [**How Prometheus Monitoring works** – YouTube](https://youtu.be/h4Sl21AKiDg)
...
* ### Profiling
  ...
  * What specific tools are there for this?
    > For Python, use: [cProfile](https://docs.python.org/3/library/profile.html), [line\_profiler](https://github.com/pyutils/line_profiler) ⭐ 3,243 | 🐛 59 | 🌐 Python | 📅 2026-08-14. <br>
    > For Node.js: [built-in Profiler](https://nodejs.org/en/docs/guides/simple-profiling/), [Clinic.js](https://github.com/clinicjs/node-clinic) ⭐ 5,953 | 🐛 108 | 🌐 JavaScript | 📅 2024-09-19, [Trace events module](https://nodejs.org/api/tracing.html). <br>
    > For Go: [runtime/pprof](https://go.dev/blog/pprof), [trace utility](https://go.dev/doc/diagnostics#tracing).

<details>
    <summary>🔗 <b>References</b></summary>

1. 📄 [**Awesome utilities for performance profiling** – GitHub](https://github.com/msaroufim/awesome-profiling) ⭐ 208 | 🐛 2 | 📅 2026-04-10
2. 📺 [**Optimize Your Python Programs: Code Profiling with cProfile** – YouTube](https://youtu.be/BZzb_Wpag_M)
3. 📺 [**A New Way to Profile Node.js** – YouTube](https://youtu.be/ASv8188AkVk)
4. 📺 [**Go (Golang) Profiling Tutorial** – YouTube](https://youtu.be/HEwSkhr_8_M)
...
* ### Benchmarks
  ...
  * What specific tools are there for this?
    > For Python: [timeit](https://docs.python.org/3/library/timeit.html), [pytest-benchmark](https://github.com/ionelmc/pytest-benchmark) ⭐ 1,447 | 🐛 119 | 🌐 Python | 📅 2026-08-23. <br>
    > For Node.js: [console.time](https://nodejs.org/api/console.html#consoletimelabel), [Artillery](https://github.com/artilleryio/artillery) ⭐ 9,057 | 🐛 485 | 🌐 TypeScript | 📅 2026-08-14. <br>
    > For Go: [testing.B](https://pkg.go.dev/testing#hdr-Benchmarks), [Benchstat](https://pkg.go.dev/golang.org/x/perf/cmd/benchstat).

  There are benchmarks to measure the performance of networked applications, where you can get detailed information about the average request processing time, the maximum number of supported connections, data transfer rates and so on ([see list of HTTP benchmarks](https://github.com/denji/awesome-http-benchmark) ⭐ 3,766 | 🐛 19 | 📅 2026-08-20).
...
* ### Caching
  ...
  * [Memcached](https://en.wikipedia.org/wiki/Memcached)
    > A daemon program that implements high-performance RAM caching based on *key-value* pairs. Unlike [Redis](#redis) it cannot be a reliable and long-term storage, so it is only suitable for caches.
...
* ### Markdown
  ...
  * [Markdown cheatsheet](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet) ⭐ 60,249 | 🐛 318 | 🌐 JavaScript | 📅 2025-08-22
    > A cheatsheet on all the syntactic possibilities of the language.
  * [Awesome README](https://github.com/matiassingers/awesome-readme) ⭐ 21,366 | 🐛 1 | 📅 2026-08-20
    > A collection of beautiful README.md files (this is the main file of any repository on GitHub that uses Markdown).
  * [Awesome Markdown](https://github.com/BubuAnabelas/awesome-markdown) ⭐ 953 | 🐛 68 | 📅 2024-08-21
...
* ### Documentation inside code
  ...
  * What does it take to get started?
    ...
    > * [JSDoc](https://github.com/jsdoc/jsdoc) ⭐ 15,455 | 🐛 458 | 🌐 JavaScript | 📅 2026-08-21 for JavaScript.
...
6. 📄 [**Awesome Microservices: collection of principles and technologies** – GitHub](https://github.com/mfornos/awesome-microservices) ⭐ 14,494 | 🐛 8 | 📅 2026-08-20
...
* [System Design 101: Explain complex systems using visuals and simple terms](https://github.com/ByteByteGoHq/system-design-101) ⭐ 87,509 | 🐛 67 | 📅 2025-04-04
* [Computer Science courses with video lectures](https://github.com/Developer-Y/cs-video-courses) ⭐ 83,172 | 🐛 3 | 📅 2026-07-07
* [System Design Course](https://github.com/karanpratapsingh/system-design) ⭐ 45,759 | 🐛 5 | 📅 2026-07-08
* [Awesome CTO – resources for Chief Technology Officers and VP R\&D](https://github.com/kuchin/awesome-cto) ⭐ 35,372 | 🐛 4 | 📅 2026-03-02
* [Awesome Sysadmin: A curated list of open source sysadmin resources](https://github.com/awesome-foss/awesome-sysadmin) ⭐ 34,984 | 🐛 0 | 📅 2026-08-19
* [How To Secure A Linux Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 30,311 | 🐛 34 | 📅 2026-07-13
* [Domain-Driven Design, software architecture, design patterns, best practices](https://github.com/Sairyss/domain-driven-hexagon) ⭐ 14,883 | 🐛 5 | 🌐 TypeScript | 📅 2024-06-11
* [Mindmaps for cyber security](https://github.com/Ignitetechnologies/Mindmap) ⭐ 9,209 | 🐛 15 | 📅 2026-07-21
* [A curated and opinionated list of resources for Backend developers](https://github.com/zhashkevych/awesome-backend) ⭐ 3,442 | 🐛 6 | 📅 2026-04-17
* [Awesome Network Automation](https://github.com/networktocode/awesome-network-automation) ⭐ 2,834 | 🐛 15 | 📅 2026-08-20
* [Best practices, tools, and guidelines for backend development](https://github.com/Sairyss/backend-best-practices) ⭐ 2,366 | 🐛 1 | 📅 2024-08-29
* [Resources related to distributed systems, system design, microservices, scalability, and performance](https://github.com/Sairyss/system-design-patterns) ⭐ 1,260 | 🐛 1 | 📅 2025-01-22
