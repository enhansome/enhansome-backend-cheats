...
2. 📄 [**Awesome Terminals** – GitHub](https://github.com/cdleon/awesome-terminals) ⭐ 2,895 | 🐛 18 | 📅 2026-07-20
...
* ### Bash scripts
  ...
  * [ShellCheck](https://github.com/koalaman/shellcheck) ⭐ 39,873 | 🐛 1,136 | 🌐 Haskell | 📅 2026-08-04 script analysis tool
    > It will point out possible mistakes and teach you best practices for writing really good scripts.
  * Additional resources
    > Repositories such as [awesome bash](https://github.com/awesome-lists/awesome-bash) ⭐ 9,990 | 🐛 6 | 🌐 Shell | 📅 2026-05-21 and [awesome shell](https://github.com/alebcay/awesome-shell) ⭐ 37,448 | 🐛 184 | 📅 2025-08-28 have entire collections of useful resources and tools to help you develop even more skills with Bash and shell in general.
...
10. 📄 [**Awesome console services** – GitHub](https://github.com/chubin/awesome-console-services) ⭐ 6,495 | 🐛 23 | 📅 2026-02-01
...
* ### Main issues with Linux
  ...
  * File system issues
    ...
    > * In case of data loss or accidental deletion, use data recovery tools like [`extundelete`](https://extundelete.sourceforge.net/) or [`testdisk`](https://github.com/cgsecurity/testdisk) ⭐ 2,525 | 🐛 89 | 🌐 C | 📅 2026-04-25.
...
1. 📄 [**JavaScript Data Structures and Algorithms** – GitHub](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,459 | 🐛 403 | 🌐 JavaScript | 📅 2026-07-26
...
1. 📄 [**Code for the book Grokking Algorithms** – GitHub](https://github.com/egonSchiele/grokking_algorithms) ⭐ 13,610 | 🐛 6 | 🌐 JavaScript | 📅 2026-04-12
...
Find a good book or online tutorial in English at [this repository](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-langs.md) ⭐ 394,407 | 🐛 80 | 🌐 Python | 📅 2026-08-11. There is a large collection for different languages and frameworks.

Look for a special [awesome repository](https://github.com/sindresorhus/awesome#programming-languages) ⭐ 495,829 | 🐛 100 | 📅 2026-06-30 - a resource that contains a huge number of useful links to materials for your language (libraries, cheat sheets, blogs, and other various resources).
...
1. 📄 [**List of libraries for working with network in Go** – GitHub](https://github.com/avelino/awesome-go#networking) ⭐ 181,074 | 🐛 209 | 🌐 Go | 📅 2026-08-14
2. 📄 [**A curated list of awesome things related to Django** – GitHub](https://github.com/wsvincent/awesome-django) ⭐ 11,201 | 🐛 7 | 🌐 Python | 📅 2026-08-03
...
* ### Asynchronous programming
  ...
  * Asynchronous in particular languages
    > * In Python, asynchronous programming can be done using the [asyncio module](https://docs.python.org/3/library/asyncio.html), which provides an event loop and coroutine-based API for concurrency. There are also other third-party libraries like [Twisted](https://github.com/twisted/twisted) ⭐ 5,975 | 🐛 2,832 | 🌐 Python | 📅 2026-08-15 and [Tornado](https://github.com/tornadoweb/tornado) ⭐ 22,189 | 🐛 253 | 🌐 Python | 📅 2026-08-07 that provide asynchronous capabilities.
...
* ### Code quality
  ...
  * [Python style guide by Google](https://github.com/google/styleguide/blob/gh-pages/pyguide.md) ⭐ 39,504 | 🐛 169 | 🌐 HTML | 📅 2026-06-03
  * [Python best practices guidebook](https://github.com/realpython/python-guide) ⭐ 29,756 | 🐛 136 | 🌐 Batchfile | 📅 2026-07-27
  * [JavaScript style guide by Airbnb](https://github.com/airbnb/javascript) ⭐ 148,135 | 🐛 162 | 🌐 JavaScript | 📅 2026-04-16
  * [Node.js best practices list](https://github.com/goldbergyoni/nodebestpractices) ⭐ 105,519 | 🐛 136 | 🌐 Dockerfile | 📅 2026-06-15
...
9. 📄 [**Google style guides** – GitHub](https://github.com/google/styleguide) ⭐ 39,504 | 🐛 169 | 🌐 HTML | 📅 2026-06-03
...
7. 📄 [**Awesome list of GraphQL** – GitHub](https://github.com/chentsulin/awesome-graphql) ⭐ 15,088 | 🐛 6 | 📅 2026-08-14
...
7. 📄 [**Awesome Docker** – GitHub](https://github.com/veggiemonk/awesome-docker) ⭐ 36,640 | 🐛 25 | 📅 2026-07-29
...
1. 📄 [**Awesome ChatGPT Prompts** – GitHub](https://github.com/f/awesome-chatgpt-prompts) ⭐ 167,137 | 🐛 65 | 🌐 HTML | 📅 2026-08-14
...
* ### Unit Tests
  ...
  * What do I need to start writing unit tests?
    ...
    > * For Go – [testify](https://github.com/stretchr/testify) ⭐ 26,157 | 🐛 364 | 🌐 Go | 📅 2026-07-21.
    > * [And so on...](https://github.com/atinfo/awesome-test-automation#awesome-test-automation) ⭐ 7,130 | 🐛 126 | 📅 2025-11-28
...
6. 📄 [**Awesome Testing** – GitHub](https://github.com/TheJambo/awesome-testing) ⭐ 2,344 | 🐛 9 | 📅 2026-08-06
...
1. 📄 [**Awesome AWS (list of libraries, open source repos, guides, blogs) – GitHub**](https://github.com/donnemartin/awesome-aws) ⭐ 14,117 | 🐛 99 | 🌐 Python | 📅 2024-03-12
...
1. 📄 [**Kubernetes Learning Roadmap** – GitHub](https://github.com/techiescamp/kubernetes-learning-path) ⭐ 7,615 | 🐛 2 | 📅 2026-05-28
...
2. 📄 [**Awesome GitHub Actions – GitHub**](https://github.com/sdras/awesome-actions) ⭐ 28,126 | 🐛 254 | 📅 2024-09-01
...
* ### Monitoring and logs
  ...
  * Libraries for your lang
    > The easiest way to log an application is to use the tools of the standard language library or third-party packages. For example, in Python you can use [logging module](https://docs.python.org/3/library/logging.html) or [Loguru](https://github.com/Delgan/loguru) ⭐ 24,071 | 🐛 265 | 🌐 Python | 📅 2026-07-01. In Node.js – [Winston](https://github.com/winstonjs/winston) ⭐ 24,506 | 🐛 528 | 🌐 JavaScript | 📅 2026-07-20, [Pino](https://github.com/pinojs/pino) ⭐ 18,135 | 🐛 164 | 🌐 JavaScript | 📅 2026-08-13. And in Go – [log package](https://pkg.go.dev/log), [Logrus](https://github.com/sirupsen/logrus) ⭐ 25,751 | 🐛 42 | 🌐 Go | 📅 2026-08-13.
  ...
  * [Graylog](https://github.com/Graylog2/graylog2-server) ⭐ 8,111 | 🐛 2,047 | 🌐 Java | 📅 2026-08-15
...
* ### Profiling
  ...
  * What specific tools are there for this?
    > For Python, use: [cProfile](https://docs.python.org/3/library/profile.html), [line\_profiler](https://github.com/pyutils/line_profiler) ⭐ 3,241 | 🐛 59 | 🌐 Python | 📅 2026-08-14. <br>
    > For Node.js: [built-in Profiler](https://nodejs.org/en/docs/guides/simple-profiling/), [Clinic.js](https://github.com/clinicjs/node-clinic) ⭐ 5,951 | 🐛 108 | 🌐 JavaScript | 📅 2024-09-19, [Trace events module](https://nodejs.org/api/tracing.html). <br>
...
* ### Benchmarks
  ...
  * What specific tools are there for this?
    ...
    > For Node.js: [console.time](https://nodejs.org/api/console.html#consoletimelabel), [Artillery](https://github.com/artilleryio/artillery) ⭐ 9,053 | 🐛 485 | 🌐 TypeScript | 📅 2026-08-14. <br>
...
* ### Markdown
  ...
  * [Awesome README](https://github.com/matiassingers/awesome-readme) ⭐ 21,322 | 🐛 1 | 📅 2026-07-27
...
* ### Documentation inside code
  ...
  * What does it take to get started?
    ...
    > * [JSDoc](https://github.com/jsdoc/jsdoc) ⭐ 15,451 | 🐛 458 | 🌐 JavaScript | 📅 2026-08-15 for JavaScript.
...
6. 📄 [**Awesome Microservices: collection of principles and technologies** – GitHub](https://github.com/mfornos/awesome-microservices) ⭐ 14,478 | 🐛 19 | 📅 2026-06-10
...
* [System Design 101: Explain complex systems using visuals and simple terms](https://github.com/ByteByteGoHq/system-design-101) ⭐ 87,060 | 🐛 67 | 📅 2025-04-04
* [Computer Science courses with video lectures](https://github.com/Developer-Y/cs-video-courses) ⭐ 83,046 | 🐛 2 | 📅 2026-07-07
* [System Design Course](https://github.com/karanpratapsingh/system-design) ⭐ 45,538 | 🐛 4 | 📅 2026-07-08
* [Awesome CTO – resources for Chief Technology Officers and VP R\&D](https://github.com/kuchin/awesome-cto) ⭐ 35,317 | 🐛 3 | 📅 2026-03-02
* [Awesome Sysadmin: A curated list of open source sysadmin resources](https://github.com/awesome-foss/awesome-sysadmin) ⭐ 34,903 | 🐛 0 | 📅 2026-06-20
* [How To Secure A Linux Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) ⭐ 30,277 | 🐛 34 | 📅 2026-07-13
* [Domain-Driven Design, software architecture, design patterns, best practices](https://github.com/Sairyss/domain-driven-hexagon) ⭐ 14,857 | 🐛 5 | 🌐 TypeScript | 📅 2024-06-11
